...
The following Table \ref{tab:jmh-results} reports the measured Score (AverageTime, ms/op) for the selected scope; additional JMH statistical fields (e.g., Cnt and Error) are available in the JSON report at reports/performance/jmh_result.json.
