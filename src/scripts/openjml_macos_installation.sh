...
echo "==> OpenJML installer per macOS"
echo "==> Installa le dipendenze necessarie (wget, unzip, z3, openjdk@17 tramite Homebrew)"
echo "==> Scarica ed installa OpenJML per macOS (versione 21-0.18)"
echo "==> Configura Z3 esterno come prover predefinito per OpenJML"
echo "==> Espone il comando 'openjml' nel PATH tramite wrapper in /usr/local/bin/openjml"

OPENJML_VERSION="21-0.18"
OPENJML_DISTRO="macos"
...
echo "==> Aggiorno Homebrew e installo dipendenze di base..."
brew update
brew install wget
brew install unzip
brew install z3
...
echo "==> Creo openjml.properties per usare z3 esterno"
...
org.openjml.prover.z3_4_3=/usr/local/bin/z3
org.openjml.defaultProver=z3_4_3
openjml.prover.z3_4_3=/usr/local/bin/z3
...
echo "==> Installazione OpenJML completata con successo su macOS."
