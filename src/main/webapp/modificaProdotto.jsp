...
%>
    ...
    <link rel="stylesheet" type="text/css" href="${assetHost}css/aggiungiProdotto.css" crossorigin="anonymous">
...
<script src="${assetHost}functions/modificaProdotto.js" crossorigin="anonymous"></script>
