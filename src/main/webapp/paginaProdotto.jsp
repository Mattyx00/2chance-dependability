...
%>
    ...
    <link rel="stylesheet" type="text/css" href="${assetHost}css/prodottoInfo.css" crossorigin="anonymous">
...
<div id="corpo-pagina">
    <div id="prodotto">
        <div id="prodotto-copertina">
            <img src="${assetHost}img/${prodotto.immagine}" alt="" crossorigin="anonymous">
        </div>
