...
public class UtenteDAO {
    ...
    public void editProfilo(String operation, String modifica, int idProfilo) throws SQLException {
        ...
        if(operation.equals("/editNome")){
            PreparedStatement stmt = connection.prepareStatement("UPDATE utente SET nome = ? WHERE id_utente = ?");
        ...
        if(operation.equals("/editCognome")){
            PreparedStatement stmt = connection.prepareStatement("UPDATE utente SET cognome = ? WHERE id_utente = ?");
            stmt.setString(1,modifica);
            stmt.setInt(2, idProfilo);
            stmt.executeUpdate();
        }
            ...
            PreparedStatement stmt = connection.prepareStatement("UPDATE utente SET email = ? WHERE id_utente = ?");
            stmt.setString(1,modifica);
            stmt.setInt(2, idProfilo);
            stmt.executeUpdate();
        }
            ...
            PreparedStatement stmt = connection.prepareStatement("UPDATE utente SET telefono = ? WHERE id_utente = ?");
            stmt.setString(1,modifica);
            stmt.setInt(2, idProfilo);
            stmt.executeUpdate();
        }
            ...
            PreparedStatement stmt = connection.prepareStatement("UPDATE utente SET immagine = ? WHERE id_utente = ?");
            stmt.setString(1,modifica);
            stmt.setInt(2, idProfilo);
            stmt.executeUpdate();
        }
